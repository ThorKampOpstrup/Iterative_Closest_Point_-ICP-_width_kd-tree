...
#define N_pt 2000        // # of points in the datasets
#define N_tests 10       // # of test iterations
...
void test_icp(void)
{
    ...
    for (int i = 0; i < N_tests; i++)
    {
        ...
        mean = std::accumulate(dist, dist + N_pt, 0.0) / N_pt;
        ...
        if (i == 3)
        {
            cout << "mean error is " << mean - 6 * noise_sigma << endl
                 << endl;
            cout << "icp trans error" << endl
                 << -t1 - t << endl
                 << endl;
            cout << "icp R error " << endl
                 << R1.inverse() - R << endl
                 << endl;
        }
    }
